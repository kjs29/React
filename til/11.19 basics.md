...
A component is a piece of UI that has its own logic and appearance. It is like a building block or a lego.
...
In `MyApp` component, `MyButton` component was used.

### I will talk about `export default` briefly
